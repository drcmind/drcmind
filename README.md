...
* If you have suggestions for adding or removing projects, feel free to [open an issue](https://github.com/drcmind/drcmind/issues/new) to discuss it, or directly create a pull request after you edit the *README.md* file with necessary changes.
* Please make sure you check your spelling and grammar.
* Create individual PR for each suggestion.
* Please also read through the [Code Of Conduct](https://github.com/drcmind/drcmind/blob/main/CODE_OF_CONDUCT.md) before posting your first idea as well.
...
Distributed under the MIT License. See [LICENSE](https://github.com/drcmind/drcmind/blob/main/LICENSE.md) for more information.
